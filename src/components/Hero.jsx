            ...
            <div className="container grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <div className="mt-6 flex flex-col items-center md:flex-row space-y-2 md:gap-4">
                        <Link to='/contact' className="px-6 py-3 max-w-60 text-center text-white font-bold bg-primary-900 hover:bg-primary-800 rounded-lg shadow">Book a Consultation✅</Link>
